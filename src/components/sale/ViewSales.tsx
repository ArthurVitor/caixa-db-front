  ...
  return sales.map((sale) => (
    {
      data: [
        ...
        {
          key: "action", value: (<Button component={Link} to={"/vendas/" + sale.id} className="" style={{backgroundColor: "#374151", color: "whitesmoke", border: "2px solid #374151", }}>Visualizar</Button>)
        },
        {
          key: "resume", value: (
            <div>
